...
Firstly I set my variables:

```
$ set HTB_PRIV 10.10.x.x
$ set HTB_PUB 10.129.218.14
```
...
Visiting the webpage at [10.129.218.14](http://10.129.218.14:80) is a webpage for Students.
...
And we see a typical server, and I now look into exploiting log4j.
