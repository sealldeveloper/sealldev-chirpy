...
> The analysis of ORG-C has given us some valuable information. These attacks have been linked to an extremist group, called "NO_NO_NO". Their focus at this point appears to be linked to train components that are shared across public transport throughout Australia. This can lead to devastating impacts.
> We've managed to track down Cipher from week 2, and with cooperation with law-enforcement, he's provided us with some valuable information regarding the insider, Layton.
> Cipher has also provided us with key intelligence, but still refuses to list where the group will strike next.
> It's your job this week to find out as much information as you can relating to the potential attack. Cipher claims we have about a week until they strike.
{: .prompt-warning}
...
![pretty_landscape.jpg](pretty_landscape.jpg)
...
- They presumed it was likely Zurich to Amsterdam, as its a common route for this airline. Airlines typically fly to and from their main country.
- Flight tracking websites generally have a limited range of data for historical, so Googling had *mostly* nothing.
- [This site](https://www.flightera.net/route/LSZH/EHAM/2023-10-20%20%2005_00) allowed for time lookups of a particular route (LZSH to EHAM).
